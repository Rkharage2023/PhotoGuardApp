...
// Import local videos via Vite — this is the correct way, not a public path string
let video1, video2;
try {
  video1 = (await import("../assets/video1.mp4")).default;
} catch {}
try {
  video2 = (await import("../assets/video2.mp4")).default;
} catch {}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {VIDEOS.map((video, i) => (
              <motion.div
                ...
                onClick={() =>
                  video.playable && video.src && setActiveVideo(video)
                }
              ...
              >
                ...
                >
                  {video.playable && video.src ? (
                    <div
                      className="w-14 h-14 rounded-full bg-white/25 backdrop-blur-sm
                    ...
                    <div className="text-center px-4">
                      <Clock size={28} className="text-white/50 mx-auto mb-1" />
                  ...
                  <div
                    className="absolute bottom-2 right-2 px-2 py-0.5 bg-black/60 text-white
                ...
                <div className="p-4">
                  ...
                  {(!video.playable || !video.src) && (
                    <span
                      className="inline-block mt-2 px-2 py-0.5 bg-gray-100 text-gray-500
                                     text-xs rounded-md"
                    >
                      Coming Soon
                    </span>
